        ...
        <SafeAreaView style={styles.mainContainer}>
            ...
            <ScrollView>
                <View style={[styles.houseContainer, { height: 236 }]}>
                    <View style={[styles.houseBackground, { height: 180 }]}>
                        <Image source={require('_assets/studioApt.png')} style={styles.studioApt}></Image>
                        <Text style={styles.houseName}>Are sure you want sell this property ?</Text>
